...
var existingRacksLayer = new google.maps.KmlLayer({	   // City of Victoria bike racks KML
...
function initialize() {
    ...
    // City of Victoria existing bike routes KML - This data is over a year old - TODO: We have the current one locally and it can be used if hosted (KML only works if http linked)
    ...
    // var existingRacksLayer = new google.maps.KmlLayer({
    //   url: 'http://www.victoria.ca/assets/City~Hall/Forms~Publications/BikeRacks.kmz',
    //   //suppressInfoWindows: true, //Suppress the rendering of info windows when layer features are clicked
