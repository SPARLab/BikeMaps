...
// Tool tip definitions. Uses title attribut of html tag.
 $(document).ready(function(){
	...
	$('.leaflet-right .leaflet-control a').tipsy({gravity:'e', delayIn: 400, fade: true});
	...
	// $('.leaflet-right .leaflet-draw-edit-remove').tipsy({gravity:'e', delayIn:400, fade: true, title: function(){ return "Delete user points"}});
