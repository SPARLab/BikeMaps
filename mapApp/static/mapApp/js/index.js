...
initializeMapOnPageLoad().then(() => {
  console.log('finished page load code');
})

async function initializeMapOnPageLoad() {
  ...
  if (!locationInURL) {
    const locationInStorage = trySettingLocationFromStorage();
