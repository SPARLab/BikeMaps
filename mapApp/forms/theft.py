    ...
    helper.layout = Layout(
        ...
        Div(
            FormActions(
                ...
                Submit('save', _('Submit'), css_class="disabled submitBtnTheft"),
            ),
