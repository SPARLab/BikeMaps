    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_type', models.CharField(default=b'official', max_length=150)),
                ('official_type', models.CharField(default=b'Vehicle collision', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_type', models.CharField(max_length=150, verbose_name=b'Type of report', choices=[(b'collision', b'collision'), (b'nearmiss', b'nearmiss'), (b'theft', b'theft'), (b'hazard', b'hazard'), (b'official', b'official')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('point', models.OneToOneField(parent_link=True, primary_key=True, serialize=False, to='mapApp.Point')),
                ('i_type', models.CharField(max_length=100, verbose_name=b'What was stolen?', choices=[(b'Bike (value < $1000)', b'Bike (value < $1000)'), (b'Bike (value >= $1000)', b'Bike (value >= $1000)'), (b'Major bike component', b'Major bike component (e.g. tire, seat, handlebars, etc.)'), (b'Minor bike component', b'Minor bike component (e.g. lights, topbar padding, bell, etc.)')])),
