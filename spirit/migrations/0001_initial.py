    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', spirit.utils.models.AutoSlugField(db_index=False, blank=True)),
                ...
                ('timezone', models.CharField(default=b'UTC', max_length=32, verbose_name='time zone', choices=[(b'Etc/GMT+12', '(GMT -12:00) Eniwetok, Kwajalein'), (b'Etc/GMT+11', '(GMT -11:00) Midway Island, Samoa'), (b'Etc/GMT+10', '(GMT -10:00) Hawaii'), (b'Etc/GMT+9', '(GMT -9:00) Alaska'), (b'Etc/GMT+8', '(GMT -8:00) Pacific Time (US & Canada)'), (b'Etc/GMT+7', '(GMT -7:00) Mountain Time (US & Canada)'), (b'Etc/GMT+6', '(GMT -6:00) Central Time (US & Canada), Mexico City'), (b'Etc/GMT+5', '(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima'), (b'Etc/GMT+4', '(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz'), (b'Etc/GMT+3', '(GMT -3:00) Brazil, Buenos Aires, Georgetown'), (b'Etc/GMT+2', '(GMT -2:00) Mid-Atlantic'), (b'Etc/GMT+1', '(GMT -1:00) Azores, Cape Verde Islands'), (b'UTC', '(GMT) Western Europe Time, London, Lisbon, Casablanca'), (b'Etc/GMT-1', '(GMT +1:00) Brussels, Copenhagen, Madrid, Paris'), (b'Etc/GMT-2', '(GMT +2:00) Kaliningrad, South Africa'), (b'Etc/GMT-3', '(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg'), (b'Etc/GMT-4', '(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi'), (b'Etc/GMT-5', '(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent'), (b'Etc/GMT-6', '(GMT +6:00) Almaty, Dhaka, Colombo'), (b'Etc/GMT-7', '(GMT +7:00) Bangkok, Hanoi, Jakarta'), (b'Etc/GMT-8', '(GMT +8:00) Beijing, Perth, Singapore, Hong Kong'), (b'Etc/GMT-9', '(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk'), (b'Etc/GMT-10', '(GMT +10:00) Eastern Australia, Guam, Vladivostok'), (b'Etc/GMT-11', '(GMT +11:00) Magadan, Solomon Islands, New Caledonia'), (b'Etc/GMT-12', '(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_count', models.PositiveIntegerField(default=0, verbose_name='comment count')),
                ('category', models.ForeignKey(verbose_name='category', to='spirit.Category')),
