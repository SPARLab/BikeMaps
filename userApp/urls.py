...
urlpatterns = patterns('',
    ...
    url(r'^password_reset/$', 'django.contrib.auth.views.password_reset', {'template_name': 'userApp/password_reset_form.html'}, name='password_reset'),
    ...
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', 'django.contrib.auth.views.password_reset_confirm', {'template_name': 'userApp/password_reset_confirm.html'}, name='password_reset_confirm'),
